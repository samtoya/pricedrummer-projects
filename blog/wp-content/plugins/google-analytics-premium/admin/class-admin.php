...
class Yoast_GA_Admin extends Yoast_GA_Options {
	...
	public function add_action_links( $links ) {
		...
		// @todo UTM link fix
		$faq_link = '<a title="MonsterInsights Knowledge Base" href="https://www.monsterinsights.com/docs/">' . __( 'FAQ', 'google-analytics-for-wordpress' ) . '</a>';
	...
	public function premium_promo() {
		...
		echo ' ';
		_e( 'This will also give you email access to the support team at MonsterInsights, who will provide support on the plugin 24/7.', 'google-analytics-for-wordpress' );
		echo '</p>';
		echo '</div>';
	}
