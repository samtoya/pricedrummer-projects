...
The Google Analytics by MonsterInsights plugin for WordPress allows you to track your blog easily and always stays up to date with the newest features in Google Analytics.

> <strong>Upgrade to GA by MonsterInsights Pro</strong><br>
> If you need support or want to use custom dimensions, upgrade to [Google Analytics by MonsterInsights Pro](https://www.monsterinsights.com/pricing/#utm_source=wporg&utm_medium=readme&utm_campaign=wpgaplugin) today!
...
> The development of Google Analytics by MonsterInsights [takes place on GitHub](https://github.com/awesomemotive/google-analytics-for-wordpress). Bugs and pull requests are welcomed there. For support, you have two options: either [buy the Pro version of Google Analytics by MonsterInsights on MonsterInsights.com](https://www.monsterinsights.com/pricing/), this will give you access to our support team, or refer to the forums.

Other interesting stuff:

* Check out the other [WordPress Plugins](https://www.monsterinsights.com/) by the same team.
...
* Bugfixes:
    * Fixes an issue where certain translation files were corrupted.
