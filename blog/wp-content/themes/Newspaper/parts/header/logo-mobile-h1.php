...
if (!empty($td_mobile_customLogoR)) { // if retina
	?>
		<a class="td-mobile-logo <?php echo $td_sticky_option?>" href="http://gh.pricedrummer.com">
	...
	?>
		<a class="td-mobile-logo <?php echo $td_sticky_option?>" href="https://www.pricedrummer.com.gh">
...
if (!empty($td_header_logoR)) { // if retina
	...
	?>
		<a class="td-header-logo <?php echo $td_sticky_option?>" href="https://www.pricedrummer.com.gh">
