						...
						<div class="prod-body">
							<div class="row">
								<form action="../include/add_products.php" method="post" enctype="multipart/form-data" id="Retailer_Products_Form">
									...
									<div class="col-lg-4 col-md-4">
										<div class="input-wrapper">
											<label class="input-label" for="model_name">Model Name
												<i class="important">*</i>
									...
									<div class="">
										...
										<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
											<div class="input-wrapper image-wrapper" id="preview-1">
												<img src="assets/images/delete.png" alt="delete icon" class="img-close hidden">
												<input type="file" id="image-1" name="other_image1" accept="image/*" multiple>
												
												<label class="input-label" for="image-1" id="label-1">
													<i class="fa fa-image fa-3x"></i> Upload an image</label>
											</div>
										</div>
										
										<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
											<div class="input-wrapper image-wrapper" id="preview-2">
												<img src="assets/images/delete.png" alt="delete icon" class="img-close hidden">
												<input type="file" id="image-2" name="other_image2" accept="image/*" multiple>
												
												<label class="input-label" for="image-2" id="label-2">
													<i class="fa fa-image fa-3x"></i> Upload an image</label>
											</div>
										</div>
										
										<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
											<div class="input-wrapper image-wrapper" id="preview-3">
												<img src="assets/images/delete.png" alt="delete icon" class="img-close hidden">
												<input type="file" id="image-3" name="other_image3" accept="image/*" multiple>
												
												<label class="input-label" for="image-3" id="label-3">
													<i class="fa fa-image fa-3x"></i> Upload an image</label>
											</div>
										</div>
