...
{
	public function index( $company_name, $page = 1, $limit = 21 )
	{
...
//        $limit = Input::get( 'limit', $limit );
		...
		$ret_prod          = fetch_data( '/api/v1/retailer_products/?retailer_id=' . $retailer_info->id );
		$retailer_products = $ret_prod->data;
...
//		dd($retailer_products);
		...
		return view( 'pages.dynamic.member' )
