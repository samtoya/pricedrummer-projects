                    ...
                    {{--<div class="bread-crumb">--}}
                        {{--<ul>--}}
                            ...
                            {{--@foreach( $breadcrumbs as $breadcrumb )--}}
                                {{--@if($loop->first)--}}
                                    {{--<li class="bc-home"><a href="">{{ $breadcrumb->name }}</a></li>--}}
                                {{--@elseif($loop->last)--}}
                                                ...
                                                <tr>
                                                    <td style="text-align: center; padding: 10px 5px;">
                                                        ...
                                                        @elseif( $retailer->is_offline == 1 )
                                                            <img src="//pricedrummer.com/images/static/retailers/{{$url_country_name}}/{{ $retailer->merchant_id }}.jpg" style="max-width: 70%;">
                                                        @endif
                                                    ...
                                                    <td style="text-align: center; vertical-align: middle;"
                                                        ...
                                                        @elseif( $retailer->is_offline == 1 )
                                                            <h5 class="descrip" title="">{{ $retailer->description }}</h5>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td style="text-align:left; vertical-align: middle;padding-right: 15px;" class="change_btn_co">
                                                        <a target="_blank" href="/redirect/{{ $retailer->product_ID }}" class="btn btn-warning">Go to Store</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
