<ul class="pagination clearfix pull-right">
    @if($compare_products_data->current_page !=1)
        <li class="page-item first">
            <a href="{{$compare_products_data->first_page_url}}" class="page-link">
                First
            </a>
        </li>
        <li class="page-item prev ">
            ...
            @if(empty($compare_products_data->prev_page_url))
            {{'#'}}
            @else
    ...
    @if($compare_products_data->current_page != $compare_products_data->last_page)
        ...
        <li class="page-item last"><a href="{{$compare_products_data->last_page_url}}" class="page-link">Last</a>
        </li>
    @endif
</ul>