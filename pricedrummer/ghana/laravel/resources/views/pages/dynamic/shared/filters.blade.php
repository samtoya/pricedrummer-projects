<div class="shop-sidebar">
    ...
    <div class="rance-wrapper" id="PriceRangeSlider">
        <div class="row MyFilterSlider">
            ...
            <div class="col-md-6 no-padding">
                <span class="maxPrice pull-right" id="p-slider-max" style="color:font-weight:bold;"><strong></strong></span>
            </div>
        </div>
    ...
    <div class="coupon-accordion">
        ...
        @foreach($category_details as $category_code => $category_values)
            <div>
                <h3 class="show filter-heading" onclick="ToggleFilterSpecs('{{ReformatID($category_code)}}')">
