...
@section('title') About PriceDrummer @stop
                    ...
                    <div id="contact" class="tab-pane active fade in">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="height: 575px;">
                                ...
                                <p>
                                    PriceDrummer is {{ $country_name }}’s no.1  shopping comparison site that help shoppers to save money. The information we provide help shoppers to make the most informed purchasing decision about a product or service. We scan through thousands of products and several retailers and present them in a clear and orderly manner.
                                </p>
