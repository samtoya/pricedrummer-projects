...
@section('title')Terms &amp Conditions at PriceDrummer {{ $country_name }} @stop

@section('meta')
    <meta name="keywords" content="Terms, conditions, PriceDrummer {{ $country_name }}" />
    <meta name="description" content="Terms &amp; conditions at PriceRunner {{ $country_name }}" />
@stop
