<?php $__env->startSection('content'); ?>
    <div class="container" style="margin-top: 20px;">
        <div class="message_container">
            ...
            <a href="#"><img id="merchant_logo" width="100px" src="http://www.pricedrummer.com/images/static/merchants/<?php echo e($url_country_name); ?>/<?php echo e($product->merchant_id); ?>.jpg" alt=""></a>
