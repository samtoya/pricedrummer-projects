...
<?php $__env->startSection('meta'); ?>
    <meta name="keywords" content="PriceDrummer <?php echo e($country_name); ?> Press">
    <meta name="description" content="PriceDrummer <?php echo e($country_name); ?> Press">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                                        <p>
                                            ...
                                            Shoppers can compare prices of products and services before they make a purchase. Smart
                                            Shopping Anytime!</p>
                                    </div>
                                </div>
                                <?php if( $country_name == "Ghana" ): ?>
                                    <div class="row">
                                    ...
                                    <div ng-if="COUNTRY == 'Ghana'"
                                        ...
                                        <address>
                                            ...
                                            Accra, Ghana <br>
                                            Email: <a style="color: #104e84;border-bottom: thin dotted;" href="mailto:press@pricedrummer.com">press@pricedrummer.com</a>
                                            <br>
