<?php $__env->startSection('title'); ?> Compare Prices - Smart Shopping in Ghana <?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>
    <meta name="keywords" content="PriceDrummer, Ghana,  price compare, price comparison, deals, product reviews, lowest prices, online shopping, forum, e-commerce, electronics"/>
    <meta name="description" content="Compare and find best prices for everything in Ghana. Save money on mobile phones, computers, cameras, fashion, TVs, laptops, furniture, washing machine. Smart Shopping"/>
                    ...
                    <div class="home-category-nav">
                        <div class="category_area">
                            ...
                            <div class="category_list">
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <?php $__currentLoopData = $category->category_children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category_lev3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                                                                <a class="nav-action"
                                                                   href="/filter/<?php echo e($category_lev3->category_ID); ?>/<?php echo e(spacelessUrl(lowercase( $category_lev3->name ))); ?>"><?php echo e($category_lev3->name); ?>

                                                                    , </a>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a class="nav-action"
                                                               href="/category/<?php echo e($category->category_ID); ?>/<?php echo e(spacelessUrl(lowercase( $category->name ))); ?>">View More</a></li>
                                                    </ul>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                ...
                                <div class="see-all_category"><a href="/all-categories">see all <i
                                        ...
                                        <div class="category-widget">
                                            ...
                                            <div class="category-widget-content">
                                                <ul>
                                                    <li>
                                                        <a href="/category/">
                                                            <img style="margin-right: 10px;" src="img/category_icons/"
                                                                 alt="">
                                                            <span style="display: inline-block; line-height: 0; margin-top: 10px;"
