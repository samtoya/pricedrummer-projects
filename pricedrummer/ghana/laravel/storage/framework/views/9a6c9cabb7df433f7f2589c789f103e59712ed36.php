...
<?php $__env->startSection('meta'); ?>
    <meta name="keywords"
          content="Compare prices on <?php echo e($category_name); ?>, Cheap <?php echo e($category_name); ?> online, reviews on <?php echo e($category_name); ?>, <?php echo e($category_name); ?>, discount <?php echo e($category_name); ?>, Cheapest <?php echo e($category_name); ?>, PriceDrummer Ghana"/>
    <meta name="description" content="Compare prices on <?php echo e($category_name); ?> on PriceRunner to help you find the best deal online"/>
    <meta property="og:title" content="<?php echo e($category_name); ?> - Best deals on PriceDrummer Ghana"/>
                                                        ...
                                                        <?php $__currentLoopData = $category_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $spec_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <span  class="FtitleOption" style="display: block;">
                                                                <a  id="<?php echo e(explode("|", $category_code)[0].$key); ?>" 
                                                                    class='<?php if(isset($_GET[ 'f_'.explode("|", $category_code)[0] ])){
