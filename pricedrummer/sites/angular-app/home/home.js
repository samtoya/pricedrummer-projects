angular.module('PxdmSite.home', ['ngRoute', 'ui.router', 'ui.bootstrap'])
    .config(function ($stateProvider) {
        $stateProvider.state('/', {
            ...
            data: {
                pageTitle: 'Compare Prices - Smart Shopping'
            }
            ...
            switch ($rootScope.COUNTRY) {
                case 'Ghana':
                    $scope.slides.push({
                            'id': '',
                            'image': 'img/5.jpg',
                            'url': 'http://blog.pricedrummer.com/top-10-smartphones-under-500-cedis/'
                        });
                ...
                case 'Nigeria':
                    $scope.slides.push({
                        'id': '',
                        'image': 'img/10.jpg',
                        'url': 'http://blog.pricedrummer.com/top-10-smartphones-30000-naira/'
                    });
                    break;
            }
