...
//        dd( $retailer_product );
    ...
    public function storeRetailerClick( Request $request )
    {
        $click_amount = - 0.1;
        ...
        $click_info = [
            ...
            'item_clicked' => $request->item_clicked,
            'category'     => $request->category,
            'product_name' => $request->product_name,
            'retailer_id' => $request->retailer_id,
            'compare_url' => baseURL() . "/compare/{$request->sc_id}/{$request->compare_product_id}",
