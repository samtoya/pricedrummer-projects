...
//	die();
	...
	$add_product_sql = "INSERT INTO `retailer_products` (`retailer_id`, `name`, `price`, `manufacturer`, `model_nuber`, `category`, `graphical_url`, `manufacturer_sku`, `has_delevery`, `availability`, `delevery_details`, `delivery_cost`, `description`)VALUES 
	(".$retailer_Id.", '".$product_name."', '".$price."', '".$manufacturer."', '".$model_name."', '".$category_id."', '".$image_url."', '".$sku."', '".$has_delivery."', '".$availability."', '".$delivery_time."', '".$delivery_cost."', '".$description."')";
