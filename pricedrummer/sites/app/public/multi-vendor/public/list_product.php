                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" type="text" class="form-control" onfocus="numberOnly(this);" onmouseenter="numberOnly(this);" onkeydown="numberOnly(this);" class="form-control" placeholder="Price GH&cent;">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
