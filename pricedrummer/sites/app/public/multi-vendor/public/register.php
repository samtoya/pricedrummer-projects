		...
		<div class="col-md-12">
			<div class="panel panel-white wizard-wrapper">
				<div class="panel-body">
					<form action="../include/add_retailer.php" method="POST" role="form" class="smart-wizard form-horizontal" id="form">
						<div id="wizard" class="swMain">
							...
							<div id="step-1">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" id="registration_number"
										       name="registration_number" placeholder="Enter your company registration number" required>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
								...
								<div class="checkbox">
									...
									<div class="col-md-7">
										...
										<label for="agree">I agree that the information provided are true and I agree to the <a href="#" class="tac">terms &amp; conditions</a>
										</label>
									</div>
								</div>
							...
							<div id="step-2">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" id="city" name="city" placeholder="Text Field" required>
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-3"></div>
							...
							<h2 class="StepTitle">Retailer Approval</h2>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<p class="form-control-static display-value" data-display="registration_number"></p>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
