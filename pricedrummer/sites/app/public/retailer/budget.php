                ...
                <div class="col-md-12 col-lg-12 col-sm-9 col-xs-12">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                            ...
                            <?php elseif ( isset( $_GET[ 'msg' ] ) && $_GET[ 'msg' ] == 'set_success' ): ?>
                                <div class="alert alert-success alert-dismissible" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                                aria-hidden="true">&times;</span></button>
                            ...
                            <?php elseif ( isset( $_GET[ 'msg' ] ) && $_GET[ 'msg' ] == 'update_failed' ): ?>
                                <div class="alert alert-danger alert-dismissible" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                                aria-hidden="true">&times;</span></button>
                                    <strong>Sorry!</strong> Budget update failed!
                                </div>
                            <?php elseif ( isset( $_GET[ 'msg' ] ) && $_GET[ 'msg' ] == 'set_failed' ): ?>
                                <div class="alert alert-danger alert-dismissible" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                                aria-hidden="true">&times;</span></button>
                                    <strong>Sorry!!</strong> Failed to set budget, please try again!
                                </div>
                            <?php endif ?>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="widget widget-wrapper hidden">
                                        ...
                                        <div class="widget-body">
                                            <div class="row">
                                                <div class="col-md-12 col-lg-12">
                                                    <h4 class="sub-title">Set your budget amount (GH&cent;20)
                                                        minimum</h4>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="money_wrapper">
                                                                <div class="money_chooser_item">
                                                                    ...
                                                                    <div class="money_image">
                                                                        <img src="assets/images/money_bag.png"
                                                                             alt="Cedi Icon">
                                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="btn-wrapper">
                                <button class="form-btn hidden" id="submit-btn" type="button">Submit</button>
                            </div>
                        </div>

                        <input type="hidden" id="retailer_id_for_budget"
                               value="<?php if ( isset( $_SESSION[ 'retailer_user_id' ] ) ) {
                                   echo $_SESSION[ 'retailer_user_id' ];
                               } ?>"/>
                        <input type="hidden" id="retailer_status_for_budget"
                               value="<?php if ( isset( $_SESSION[ 'retailer_status' ] ) ) {
                                   echo $_SESSION[ 'retailer_status' ];
                               } ?>"/>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (String(data).trim() == "SET_SUCCESS") {
                        ...
                        window.location.href = "list_product.php?msg=set_success";

                    }
                    if (String(data).trim() == "SET_FAILED") {

                        window.location.href = "budget.php?msg=set_failed";

                    }
                    if (String(data).trim() == "UPDATE_SUCCESS") {

                        window.location.href = "budget.php?msg=update_success";

                    }
                    if (String(data).trim() == "UPDATE_FAILED") {

                        window.location.href = "budget.php?msg=update_failed";
