                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="onoffswitch">
                                                        <input type="checkbox"
                                                               onclick="ProcessAvailability(this,'<?php echo $row[ 'id' ]; ?>');"
                                                               name="onoffswitch" class="onoffswitch-checkbox"
                                                               id="myonoffswitch<?php echo $No; ?>"
                                                            <?php if ( trim( $row[ 'availability' ] ) == 1 ) {
                                                                echo "checked";
                                                            } ?>>
                                                        <label class="onoffswitch-label"
                                                               for="myonoffswitch<?php echo $No; ?>">
                                                ...
                                                <td style="text-align: right;">
                                                    <a href="edit_product.php?Pid=<?php echo $row[ 'id' ]; ?>&sgoto=<?php echo urlencode( $Url_Params_For_Post ); ?>"
                                                       class="action edit"><img src="assets/images/edit.png"
                                                                                alt="edit icon"></a>
                                                    <a title="delete"
                                                       onclick="deleteProduct(this,'<?php echo $row[ 'id' ]; ?>');"
                                                       href="javascript:void(0);" class="action delete"><img
                                                                src="assets/images/delete.png" alt="delete icon"></a>
                                                </td>
                                            </tr>
                                            <?php
                                            $No ++;
