                                                        ...
                                                        <div class="al_navContent cat-top">
                                                            <h3>
                                                                <a style="color: #FFFFFF;"
                                                                   href="/category/{{ $category->category_ID }}/{{spacelessUrl(lowercase( $category->name ))}}">{{$category->name}}</a>
                                                            </h3>
                    ...
                    <div class=row>
                        <div class="col-md-3 hidden-sm hidden-xs">
                            <div class=logo-footer style="width: 80%; margin-top: 0px;">
                                <a href="/"><img src="{{ asset('/img/site-logo/pxdm_logo_bw.png') }}"
