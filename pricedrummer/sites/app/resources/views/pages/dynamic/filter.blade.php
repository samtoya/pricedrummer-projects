...
{{--@section('meta')--}}
    ...
    {{--<meta name="description"--}}
          {{--content="Compare prices on {{$category_name}} on PriceDrummer to help you find the best deal online"/>--}}
...
@section('meta')
    @if ( $category_name == "Electronics & Computers")
    ...
    @elseif ( $category_name == "Camcoders" )
    ...
    @elseif ( $category_name == "Projectors" )
    ...
    @elseif ( $category_name == "Home Theater Systems" )
    ...
    @elseif ( $category_name == "Mobile Phones" )
    ...
    @elseif ( $category_name == "Game Consoles" )
    ...
    @elseif ( $category_name == "Home & Garden" )
    ...
    @elseif ( $category_name == "Toys, Children & Family" )
    ...
    @elseif ( $category_name == "Clothes, Shoes & Jewellery" )
    ...
    @elseif ( $category_name == "Health & Beauty" )
    ...
    @elseif ( $category_name == "Autos & Accessories" )
    ...
    @else
        <meta name="description"
              content="{{ $category_name }}. Compare {{ $country_name }} prices for {{ $category_name }} brands, read product reviews and use our easy price comparison to help you find the best value online at PriceDrummer in {{ $country_name }}"/>
        <meta property="og:description"
              content="Find the cheapest prices on {{ $category_name }} on PriceDrummer {{ $country_name }}"/>
        <meta name="keywords"
              content="{{ $category_name }}, Compare {{ $category_name }} prices, Cheap {{ $category_name }} products online, reviews on {{ $category_name }} products, expert {{ $category_name }} reviews,  discount {{ $category_name }}, cheapest {{ $category_name }} products online, PriceDrummer {{ $country_name }}"/>
    @endif

    <meta property="og:title" content="{{ $category_name }} – Best deals on PriceDrummer {{ $country_name }}"/>
    <meta name="og:description" content="Compare prices and save money on the best deals for {{ $category_name }}, and more on PriceDrummer in {{ $country_name }}.">
@stop
    ...
    <div class="visible-xs">
        <div class="filter_area_wrapper" id="filter_area_wrapper">
            <div class="filter_box" id="filter_area">
                {{--Content of mobile filter starts here--}}
                @include('pages.dynamic.shared.mobile_filters')
                {{--Content of mobile filter ends here--}}
            </div>
        </div>
    </div>
                    ...
                    <div class="shop-short-wrapper clearfix">
                        ...
                        <div class="shop-sort clearfix">
                            <ul class="pull-left" style="font-size: 12px; padding: 10px;">
                                <li class="hidden-xs"
                                    style="margin-left: 5px; font-weight: 600;">{{$compare_products_data->total}}
                                    products
                                </li>
                            </ul>
                        ...
                        <div class="shop-sort visible-xs mobile_meta">
                            <ul class="" style="">
                                <li class="pull-left mtotal" style="">
                                    <span>{{$compare_products_data->total}}</span>
                                    products
                                </li>
