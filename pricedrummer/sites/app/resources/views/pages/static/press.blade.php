...
@section('title') Press - PriceDrummer @stop

@section('meta')
    <meta name="keywords" content="PriceDrummer {{ $country_name }} Press">
    <meta name="description" content="PriceDrummer {{ $country_name }} Press">
@stop
