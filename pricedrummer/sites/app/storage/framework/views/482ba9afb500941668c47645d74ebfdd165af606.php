<ul class="pagination clearfix pull-right">
    <?php if($compare_products_data->current_page !=1): ?>
        <li class="page-item first">
            <a id="pagination-first" href="<?php echo e($compare_products_data->first_page_url); ?>" class="page-link">
                First
            </a>
        </li>
        <li class="page-item prev ">
            ...
            <?php if(empty($compare_products_data->first_page_url)): ?>
            <?php echo e('#'); ?>
    ...
    <?php if($compare_products_data->current_page != $compare_products_data->last_page): ?>
        ...
        <li class="page-item last"><a id="pagination-last" href="<?php echo e($compare_products_data->last_page_url); ?>" class="page-link">Last</a>
        </li>
    <?php endif; ?>
</ul>