                                    ...
                                    <div class="cat_header">
                                        <ul>
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($category->category_ID != '537'): ?>
                                                    <li>
                                                        <h3>
                                                            <a href="/category/<?php echo e($category->category_ID); ?>/<?php echo e(spacelessUrl(lowercase( $category->name ))); ?>">
                                                                <img width="36" height="36" src="<?php echo e(asset('/img/category_icons/' . ReformatID($category->name) . '.png')); ?>"
                                    ...
                                    <?php $__currentLoopData = $home_quick_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-4 col-lg-4 col-sm-6 no-padding panel-widget-thumbs">
                                            ...
                                            <div class="col-md-4 col-sm-3 no-padding"><img
                                                        ...
                                                        src="<?php echo e(asset('img/60x60/' . $category->image)); ?>" width="60" height="60"
                    ...
                    <div class="col-md-7 col-sm-7 hidden-xs" style="padding-right: 0px;">
                        <div class="social-media-area">
                            <div class="panel panel-default">
                                <div class="panel-body" style="padding:0;">
                                    <div class="fb-page" data-href="https://www.facebook.com/PriceDrummer<?php echo e($country_code); ?>"
                                         data-tabs="timeline" data-width="358" data-height="215"
                                         data-small-header="false" data-adapt-container-width="true"
                                         data-hide-cover="false" data-show-facepile="true">
                                        <blockquote cite="https://www.facebook.com/PriceDrummer<?php echo e($country_code); ?>"
                                                    class="fb-xfbml-parse-ignore"><a
                                                    href="https://www.facebook.com/PriceDrummer<?php echo e($country_code); ?>">PriceDrummer.com -
                                                compare prices in <?php echo e($country_name); ?></a></blockquote>
                                    </div>
                                </div>
                            </div>
                        </div>
