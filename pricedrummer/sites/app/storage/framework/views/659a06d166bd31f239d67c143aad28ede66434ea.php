<?php $__env->startSection('title'); ?> Compare Electronics & Computer Prices - PriceDrummer Ghana <?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>
    <meta name="keywords" content="Computers, Compare Computers prices, Cheap Computers products online, reviews on Computers products, expert Computers reviews,  discount Computers, cheapest Computers products online, PriceRunner" />
    <meta name="description" content="Electronics & Computers. Compare Ghana prices for Electronics & Computers brands, read product reviews and use our easy price comparison to help you find the best value online at PriceDrummer" />
    <meta property="og:url" content="http://gh.pricedrummer.com/category/1/electronics-&-computers"/>
    <meta property="og:title" content="Electronics & Computers – Best deals on PriceDrummer Ghana"/>
    <meta property="og:url" content="http://gh.pricedrummer.com/category/1/electronics-&-computers"/>
    <meta property="og:description" content="Find the cheapest prices on Electronics & Computers on PriceDrummer Ghana"/>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 hidden-xs col-lg-12" style="margin-top: -10px;">
                <div class="breadcrumb">
                    ...
                    <div class="bread-crumb">
                        <ul ng-show="Breadcrumb.length>0">
            ...
            <div class="visible-xs col-xs-12" style="margin-top: -10px;">
                <div class="breadcrumb">
                    ...
                    <div class="bread-crumb">
                        <ul ng-show="Breadcrumb.length>0">
                            <li class="bc-home" ng-show="Breadcrumb.length>0"><a href="/">PriceDrummer</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="row">
                                            <div class="image_wrapper">
                                                <img src="/img/cat_images/<?php echo e(ReformatID( $category_l2->name )); ?>.png" alt="asqwsada" title="">
                                            </div>

                                        </div>
                                        <div style="margin-top: 10px;_max-height: 105px;overflow: hidden;transition: all 2s ease;" id="category_lev_3_list" class="row">
                                            <div class="list_info">
                                                <ul>
                                                    <?php $__currentLoopData = $category_l2->lev3s; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category_l3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                                            ...
                                                            class="<?php if(count($category_l3->lev4s) >0){echo'disabled';}else{echo'';} ?>" 
                                                           <?php 
                                                            ...
                                                            <?php echo e($category_l3->name); ?>
                                                                ...
                                                                <?php $__currentLoopData = $category_l3->lev4s; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category_l4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <div  class="level-4sub" style="margin-left: 17px; font-size: 11px;">
                                                                        <a style="font-size: 12px;" href="/filter/<?php echo e($category_l4->category_id); ?>/<?php echo e(spacelessUrl(lowercase($category_l4->name))); ?>" title=""><?php echo e($category_l4->name); ?></a>
                                                                    </div>
