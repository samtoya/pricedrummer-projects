                                                ...
                                                <tr>
                                                    <td style="text-align: center; padding: 10px 5px;">
                                                        <?php if( $retailer->is_offline == 0 ): ?>
                                                            <img src="//pricedrummer.com/images/static/merchants/<?php echo e($url_country_name); ?>/<?php echo e($retailer->merchant_id); ?>.jpg" style="max-width: 70%;">
                                                        <?php elseif( $retailer->is_offline == 1 ): ?>
                                                            <img src="//pricedrummer.com/images/static/retailers/<?php echo e($url_country_name); ?>/<?php echo e($retailer->retailer_id); ?>.jpg" style="max-width: 70%;">
                                                        <?php endif; ?>
                                                    ...
                                                    <td style="text-align: center; vertical-align: middle;"
                                                        ...
                                                        <?php elseif( $retailer->is_offline == 1 ): ?>
                                                            <h5 class="descrip" title=""><?php echo e($retailer->name); ?></h5>
                                                        <?php endif; ?>
                                                    </td>
                                                    ...
                                                    <?php if( $retailer->is_offline == 0 ): ?>
                                                        <td style="text-align:left; vertical-align: middle;padding-right: 15px;" class="change_btn_co">
                                                            <a target="_blank" href="/redirect/<?php echo e($retailer->product_ID); ?>?curl=<?php echo e(urlencode($compare_product->compare_url)); ?>" class="btn btn-warning">Go to Store</a>
                                                        </td>
                                                    <?php elseif( $retailer->is_offline == 1 ): ?>
                                                        <td style="text-align:left; vertical-align: middle;padding-right: 15px;" class="change_btn_co">
                                                            <a  href="<?php echo e($retailer->url); ?>" class="btn btn-warning">Contact Seller</a>
                                                        </td>
                                                    <?php endif; ?>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
