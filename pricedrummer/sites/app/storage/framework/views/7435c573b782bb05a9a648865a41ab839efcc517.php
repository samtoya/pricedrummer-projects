...
<!-- Internal Stylesheets -->
    ...
    <link rel=stylesheet type="text/css" href="<?php echo e(asset('/bower_components/angularjs-slider/dist/rzslider.min.css')); ?>"/>
    <link rel=stylesheet type="text/css" href="<?php echo e(asset('/css/jquery.simpleGallery.css')); ?>">
    ...
    <link href="<?php echo e(asset('/css/ninja-slider.css')); ?>" rel=stylesheet/>
    ...
    <script type="text/javascript" src="<?php echo e(asset('/js/jssor.slider-21.1.5.mini.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/jssor_slider.js')); ?>"></script>
                                                ...
                                                <div>
                                                    <div class="col-md-2 col-sm-3">
                                                        <div class="al_navContent cat-top">
                                                            <h3>
                                                                <a style="color: #FFFFFF;" href="/category/<?php echo e($category->category_ID); ?>/<?php echo e(spacelessUrl(lowercase( $category->name ))); ?>"><?php echo e($category->name); ?></a>
                                                            </h3>
    ...
    <div class=search-wrapper>
        <div class=search-content>
            ...
            <form autocomplete=off action="/search" method="GET"  id=search_form >
                ...
                <input type=search id=home_serch_input placeholder="I'm looking for..." name="search" />
                <div class=Search-suggestions
                ...
                <div class="col-md-3 col-sm-6 hidden-xs">
                    <div class=single-footer>
                        ...
                        <div class=footer-list>
                            <ul>
                                <li class=footer-list-item><a href="/about">About PriceDrummer</a></li>
                        ...
                        <div class=footer-list>
                            <ul>
                                <li class=footer-list-item">
                                    <a target=_blank href="//blog.pricedrummer.com">Blog</a>
                                </li>
                                <li class=footer-list-item">
                                    <a target=_blank href="//blog.pricedrummer.com">Facebook</a>
                                </li>
                                <li class=footer-list-item">
                                ...
                                <li class=footer-list-item">
                                    <a target=_blank href="//www.linkedin.com/company-beta/15228908">Linkedin</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class=row>
                        <div class="col-md-3 hidden-sm hidden-xs">
                            <div class=logo-footer style="width: 80%; margin-top: 0px;">
                                <a href="/"><img src="<?php echo e(asset('/img/site-logo/pxdm_logo_bw.png')); ?>" alt="PriceDrummer Logo" width=200
                                                 height=50/></a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-0">
                            <div class="social-icon-footer pull-right">
                                <ul class=social-icons>
                                    <li>
                                        <a target=_blank data-toggle=tooltip data-placement=top title=Facebook
                                           href="//www.facebook.com/PriceDrummerGH" target=_blank>
                                            <i class="fa fa-facebook"></i>
                                        </a>
                                    </li>
                                    <li><a data-toggle=tooltip title=Twitter href="//twitter.com/PriceDrummer_GH"><i
                                                    class="fa fa-twitter" target=_blank></i></a>
                                    </li>
                                    <li><a data-toggle=tooltip title=Instagram
                                           href="//www.instagram.com/pricedrummer_gh/" target=_blank><i
                                                    class="fa fa-instagram"></i></a>
                                    </li>
                                    <li><a data-toggle=tooltip title="Google Plus" href="#"><i
                                                    class="fa fa-google-plus"></i></a>
                                    </li>
                                    <li><a data-toggle=tooltip title=Linkedin href=""><i class="fa fa-linkedin"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class=mf-social-icons>
                <ul class=social-icons>
                    <li><a data-toggle=tooltip data-placement=top title=Facebook
                           href="//www.facebook.com/PriceDrummerGH/" target=_blank><i class="fa fa-facebook"></i></a>
                    </li>
                    <li><a data-toggle=tooltip title=Twitter href="//twitter.com/PriceDrummer_GH" target=_blank><i
                                    class="fa fa-twitter"></i></a>
                    </li>
                    <li><a data-toggle=tooltip title=Instagram href="//www.instagram.com/pricedrummer_gh/"
                           target=_blank><i class="fa fa-instagram"></i></a>
                    </li>
                    <li><a data-toggle=tooltip title="Google Plus" href="#"><i class="fa fa-google-plus"></i></a>
                    </li>
                    <li><a data-toggle=tooltip title=Linkedin href=""><i class="fa fa-linkedin"></i></a>
                    </li>
                </ul>
...
<script type="text/javascript" src="<?php echo e(asset('/js/jquery.simpleGallery.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('//cdnjs.cloudflare.com/ajax/libs/bootstrap-drawer/1.0.6/js/drawer.min.js')); ?>"></script>
...
$('#home_serch_input').keyup(function () {
    ...
    timer = setTimeout(function (event) {
        ...
        if(search_text.trim().length < 1){
            ...
            $.ajax({
               method: 'GET',
               url: '/pricedrummer2.0/public/api/v1/productcompare/?search=' + search_text + '&limit=6',
               success: function( response ) {
                   data = response.data;
                   console.log(data);
