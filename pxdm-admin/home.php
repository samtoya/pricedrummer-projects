							...
							<div class="col-md-12">
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										<ul id="Grid" class="list-unstyled" align="center">
											<center>
													<li class="col-md-3 col-sm-6 col-xs-12 mix category_1 gallery-img" data-cat="1">
														<div class="portfolio-item">
															<p>
																<a href="standard/select_cat.php" style="width: 225px;" class="btn btn-lg btn-success">
																	Standard Catalog Data Admin
																</a>
															</p>
														</div>
													</li>
													...
													<li class="col-md-3 col-sm-6 col-xs-12 mix category_1 gallery-img" data-cat="1">
														<div class="portfolio-item">
															<p>
																<a href="select_cat.php" style="width: 225px;" class="btn btn-lg btn-primary">
																	Crawled Data Admin
																</a>
															</p>
														</div>
													...
													<li class="col-md-3 col-sm-6 col-xs-12 mix category_1 gallery-img" data-cat="1">
														<div class="portfolio-item">
															<p>
																<a href="standard/select_cat.php?quality_check=1" style="width: 225px;" class="btn btn-lg btn-info">
																	Data Quality Check
																</a>
															</p>
														</div>
