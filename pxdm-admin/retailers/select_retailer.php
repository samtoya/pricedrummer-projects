<?php
	...
	$retailers_sql = 'SELECT * FROM `retailers`';
							...
							<div class="col-md-12">
								...
								<div class="panel panel-danger">
									<div class="panel-heading">
										<h1 class="panel-title"style = "font-size: 20px;">Select Retailer
											...
											if ($retailers_result->num_rows > 0) {
												$No = 1;
													while($row = $retailers_result->fetch_assoc()) {
														...
														<td>
															<a href="../retailer_product_list.php?linked=&rid=<?php echo $row['id']?>" class="btn btn-success">View Products</a>
														</td>
														<td>
															<a href="../retailer_product_list.php?unlinked=&rid=<?php echo $row['id']?>" class="btn btn-default">View Products</a>
														</td>
														<td>
															<a href="../retailer_product_list.php?all=&rid=<?php echo $row['id']?>" class="btn btn-info">View Products</a>
														</td>
