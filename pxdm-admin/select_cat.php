								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<div class="row">
											<div class="col-md-8">
												<div class="controls">
											<h5>Level One Categories</h5>
										</div>
											</div>
											<div class="col-md-4">
												<form class="" id="searchSCproduct" method="GET" action="crawled_list.php">
													<div class="input-group">
														
														<input type="text" class="form-control" name="Search" placeholder="Search Merchants Products">
												...
												if ($result->num_rows > 0) {
													...
													<li class="col-md-3 col-sm-6 col-xs-12 mix category_1 gallery-img" data-cat="1">
														<div class="portfolio-item">
															<p>
																<button data-target="#basicmodal" data-toggle="modal" style="width: 225px;" class="btn btn-lg btn-primary" onclick="$('#Category_hidden_input').val('<?php echo $row["category_ID"];?>'); $('#Drill_Level').val(1); get_cat_lev_2('<?php echo $row["category_ID"];?>')">
																	<?php echo $row["name"];?>
																</button>
															</p>
														</div>
						...
						<form action="" method="get" id="select_state">
							...
							<div class="row">
								...
								<div class="col-md-3" style="margin-bottom: 20px;">
									<button style="width: 100%;" type="submit" id="Uncategorised" name="Uncategorised" class="btn btn-danger" type="button"onclick=" $('#select_state').attr('action', 'crawled_list.php');">
										Uncategorised <i class="fa fa-puzzle-piece"></i>
									</button>
								</div>
								<div class="col-md-3" style="margin-bottom: 20px;">
									<button class="btn btn-success" type="submit" id="Categorised" name="Categorised" style="width: 100%;" type="button" onclick="$('#select_state').attr('action', 'crawled_list.php');">
										Categorised <i class="fa fa-save"></i>
									</button>
								</div>
								<?php if(isset($_SESSION['user_id']) && $_SESSION['user_id']=='5'){?>
								<div class="col-md-3" style="margin-bottom: 20px;">
									<button class="btn btn-primary" type="submit" id="Tagged" name="Tagged" style="width: 100%;" type="button" onclick="$('#select_state').attr('action', 'crawled_list.php');">
										Tagged <i class="fa  fa-flag-checkered"></i>
									</button>
								</div>
								<?php }?>
								<div class="col-md-3" style="margin-bottom: 20px;">
									<button class="btn btn-info" type="submit" id="Revise" name="Categorised" style="width: 100%;" type="button" onclick="$('#select_state').attr('action', 'standard/review_product_list.php');">
										Revise <i class="fa fa-eye "></i>
									</button>
								</div> 
								<div class="col-md-3" style="margin-bottom: 20px;">
									<button class="btn btn-warning" type="submit" id="In_SC" name="In_SC" style="width: 100%;" type="button" onclick="$('#select_state').attr('action', 'crawled_list.php');">
										In SC <i class="fa fa-save"></i>
									</button>
								</div>
								<div class="col-md-3" style="margin-bottom: 20px;">
<!--									<button class="btn btn-default" type="submit" id="Off_Re" name="Off_Re" style="width: 100%;" type="button" onclick="$('#select_state').attr('action', 'retailer_product_list.php');">-->
<!--										Offline Retailers <i class="fa fa-map-marker"></i>-->
<!--									</button>-->
								</div>
