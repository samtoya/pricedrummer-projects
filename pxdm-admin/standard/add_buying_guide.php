										...
										<div class="row guide" >
											<div class="col-md-5 no-padding no-margin">
												<div class="form-group">
													...
													<br/>
													<select name="BuyingGuide[HeadingTag][]" class="form-control" style="width: 50%;">
											...
											<div class="col-md-2 no-padding no-margin">
												...
												<input placeholder="Image Alt Text Here" class="form-control Heading" name="BuyingGuide[image_alt_text][]" value=""  data-toggle="tooltip" type="text" />
											</div>
										</div>
