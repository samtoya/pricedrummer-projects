                            ...
                            <div class="car-list listing-style3 car">
                                ...
                                <article class="box">
                                    ...
                                    <div class="details col-xs-9 clearfix">
                                        <div class="col-sm-8">
                                            <div class="clearfix">
                                                <h4 class="box-title">Economy Car<small>vokswagen polo</small></h4>
                                                <div class="logo">
                                                    <img src="http://placehold.it/110x25" alt="" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-6 col-sm-2 character">
                                            <dl>
                                                <dt class="skin-color">mileage</dt><dd>8000 miles</dd>
                                                <dt class="skin-color">Pickup Time</dt><dd>5:45 pm</dd>
                                                <dt class="skin-color">Location</dt><dd>London city</dd>
                                            </dl>
                                        </div>
                                        <div class="action col-xs-6 col-sm-2">
                                            <span class="price"><small>per day</small>$40.55</span>
                                            <a href="car-detailed.html" class="button btn-small full-width">select</a>
                                        </div>
                                    </div>
                                </article>
                                ...
                                <article class="box">
                                    ...
                                    <div class="details col-xs-9 clearfix">
                                        ...
                                        <div class="col-xs-6 col-sm-2 character">
                                            <dl>
                                                <dt class="skin-color">mileage</dt><dd>12000 miles</dd>
                                                <dt class="skin-color">Pickup Time</dt><dd>5:45 pm</dd>
                                                <dt class="skin-color">Location</dt><dd>London city</dd>
                                            </dl>
                                        </div>
