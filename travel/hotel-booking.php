                    ...
                    <nav id="main-menu" role="navigation">
                        <ul class="menu">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul>
                                    <li><a href="hotel-index.php">Home Hotels</a></li>
                                    <li><a href="hotel-list-view.php">List View</a></li>
                                    <li><a href="hotel-grid-view.php">Grid View</a></li>
                                    <li><a href="hotel-block-view.php">Block View</a></li>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul>
                                    <li><a href="flight-index.php">Home Flights</a></li>
                                    <li><a href="flight-list-view.php">List View</a></li>
                                    <li><a href="flight-grid-view.php">Grid View</a></li>
                                    <li><a href="flight-block-view.php">Block View</a></li>
                                    <li><a href="flight-detailed.html">Detailed</a></li>
                                    <li><a href="flight-booking.php">Booking</a></li>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul>
                                    <li><a href="car-index.php">Home Cars</a></li>
                                    <li><a href="car-list-view.php">List View</a></li>
                                    <li><a href="car-grid-view.php">Grid View</a></li>
                                    <li><a href="car-block-view.php">Block View</a></li>
                        ...
                        <div class="booking-details travelo-box">
                            ...
                            <article class="image-box hotel listing-style1">
                                <figure class="clearfix">
                                    <a href="hotel-detailed.php" class="hover-effect middle-block"><img class="middle-item" width="270" height="160" alt="" src="http://placehold.it/270x160"></a>
